...
signature <- read.csv( file.path(dir_GeneSig_info, "signature_information_io.csv")) 
...
load(file.path(dir_GeneSig, 'IO', "ADO_Sidders.rda"))
...
knitr::include_graphics(file.path(app_dir, 'SignatureSets', 'vignettes', 'PatternSignatures.png'))
